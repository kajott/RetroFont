...
const RF_System RF_Sys_Amiga_KS2_NTSC  = { RF_MAKE_ID('A','2','N','p'), "Commodore Amiga (Kickstart 2/3, NTSC)",            &amigaclass, {640|RF_SIZE_PIXELS,200|RF_SIZE_PIXELS}, {0,0},  {0,0},  {60,20}, {58,20}, {1,2},      0, RF_MAKE_ID('T','8','2','0') };
const RF_System RF_Sys_Amiga_KS2_NTSCi = { RF_MAKE_ID('A','2','N','i'), "Commodore Amiga (Kickstart 2/3, NTSC interlaced)", &amigaclass, {640|RF_SIZE_PIXELS,400|RF_SIZE_PIXELS}, {0,0},  {0,0},  {60,40}, {58,40}, {1,1},      0, RF_MAKE_ID('T','9','2','0') };
const RF_System RF_Sys_Amiga_KS2_PAL   = { RF_MAKE_ID('A','2','P','p'), "Commodore Amiga (Kickstart 2/3, PAL)",             &amigaclass, {640|RF_SIZE_PIXELS,256|RF_SIZE_PIXELS}, {0,0},  {0,0},  {48,16}, {48,16}, {1,2},      0, RF_MAKE_ID('T','8','2','0') };
const RF_System RF_Sys_Amiga_KS2_PALi  = { RF_MAKE_ID('A','2','P','i'), "Commodore Amiga (Kickstart 2/3, PAL interlaced)",  &amigaclass, {640|RF_SIZE_PIXELS,512|RF_SIZE_PIXELS}, {0,0},  {0,0},  {48,32}, {48,32}, {1,1},      0, RF_MAKE_ID('T','9','2','0') };

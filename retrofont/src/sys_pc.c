...
const RF_System RF_Sys_VGA25   = { RF_MAKE_ID('V','G','A','8'), "PC (VGA 80x25 text)",     &pcclass, default_vga, {80,25}, { 9,16}, { 8,16}, {8,8}, {8, 8}, {1,1},   228, RF_MAKE_ID('P','C','6','V') };
const RF_System RF_Sys_VGA28   = { RF_MAKE_ID('V','G','A','2'), "PC (VGA 80x28 text)",     &pcclass, default_vga, {80,28}, { 9,14}, { 8,14}, {8,8}, {8,14}, {1,1},   228, RF_MAKE_ID('P','C','4','V') };
const RF_System RF_Sys_VGA50   = { RF_MAKE_ID('V','G','A','5'), "PC (VGA 80x50 text)",     &pcclass, default_vga, {80,50}, { 9, 8}, { 8, 8}, {8,8}, {8, 8}, {1,1},   228, RF_MAKE_ID('P','C','8','V') };
const RF_System RF_Sys_VGA25_G = { RF_MAKE_ID('V','G','g','3'), "PC (VGA 80x30 graphics)", &pcclass, default_vga, {80,30}, { 8,16}, { 8,16}, {8,8}, {8, 8}, {1,1},   266, RF_MAKE_ID('P','C','6','V') };
const RF_System RF_Sys_VGA28_G = { RF_MAKE_ID('V','G','g','4'), "PC (VGA 80x34 graphics)", &pcclass, default_vga, {80,34}, { 8,14}, { 8,14}, {8,8}, {8,18}, {1,1},   266, RF_MAKE_ID('P','C','4','V') };
const RF_System RF_Sys_VGA50_G = { RF_MAKE_ID('V','G','g','6'), "PC (VGA 80x60 graphics)", &pcclass, default_vga, {80,60}, { 8, 8}, { 8, 8}, {8,8}, {8, 8}, {1,1},   266, RF_MAKE_ID('P','C','8','V') };

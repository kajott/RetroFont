...
const uint32_t charmap_cp437[256] = {
    0x00A0, 0x263A, 0x263B, 0x2665, 0x2666, 0x2663, 0x2660, 0x2022,  // 00-07
...
const uint8_t common_cp437[] = { 0x80,0x9A, 0xA0,0xA5, 0xE1,0xE1, 0 };
const uint8_t run_cp437[] = { 0xB0, 0xB1, 0xB2, 0xC4, 0xCD, 0xDB, 0xDC, 0xDF, 0 };

const uint32_t charmap_cp1252[256] = {
...
const RF_Charset RF_Charsets[] = {
    ...
    { RF_MAKE_ID('0','4','3','7'),   437, "cp437",  "MS-DOS Codepage 437",                         charmap_cp437,  common_cp437,  run_cp437 },
    { RF_MAKE_ID('1','2','5','2'),  1252, "cp1252", "Windows Codepage 1252 / Extended ISO-8859-1", charmap_cp1252, common_cp1252, NULL },
